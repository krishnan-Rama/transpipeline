...
busco -i ${assemblydir}/${assembly}.fasta -m trans -o ${assembly} --out_path ${buscodir} -l metazoa_odb10 -c ${SLURM_CPUS_PER_TASK}

busco -i ${assemblydir}/${assembly}_okay.fasta -m trans -o ${assembly}_okay --out_path ${buscodir} -l metazoa_odb10 -c ${SLURM_CPUS_PER_TASK}

cp ${buscodir}/${assembly}/short_summary.specific.metazoa_odb10.${assembly}.txt ${outdir}/short_summary.specific.metazoa_odb10.${assembly}.txt

cp ${buscodir}/${assembly}_okay/short_summary.specific.metazoa_odb10.${assembly}_okay.txt ${outdir}/short_summary.specific.metazoa_odb10.${assembly}_okay.txt
